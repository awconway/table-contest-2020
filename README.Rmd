...
An [RStudio Cloud](https://rstudio.cloud/project/1821247) project is available to demonstrate how flextable (and officedown) can be used to produce the table in static-print format.
